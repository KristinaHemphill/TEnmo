...
public class JdbcTransferDAO implements TransferDAO {
    ...
    private final String joinTemplate = "SELECT t.transfer_id, t.account_from, t.account_to, t.amount, tt.transfer_type_desc, ts.transfer_status_desc FROM transfer t " +
    ...
    //Lists all transfers for entered acct with the approved status Id
    @Override
    ...
    // Lists any transfers with pending status type from given account id
    @Override
   ...
   //retrieves transfer by transfer id
    @Override
    ...
    //Method to create transfer by adding to a balance as well as subtracting transfer ammount from the from acct
    @Override
    ...
    // method to create transfer request
    @Override
    ...
    //Updates sql transfer_status table for approved transfers
    @Override
    ...
    //Updates sql transfer_status table for rejected transfers
    @Override
