...
public class TenmoService {
    ...
    public void setAuthToken(String authToken) {
      ...
      //This method creates a new HttpEntity specific to transfer methods
    private HttpEntity<TransferDTO> makeTransferEntity(TransferDTO transferDTO) {
     ...
     //This method will return an HttpEntity with the `Authorization: Bearer:` header
    ...
    //connecting endpoint for get balance method
   ...
   // allows transfer requests to entered userIds
